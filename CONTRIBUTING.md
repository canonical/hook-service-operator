...
- Generally, before developing bugs or enhancements to this charm, you
  should [open an issue](https://github.com/canonical/hook-service-operator/issues)
...
install `pre-commit`, `mypy` type checker, linting and formatting tools, as well
...
# Deploy the charm
juju deploy ./hook-service*.charm --resource oci-image=$(yq eval '.resources.oci-image.upstream-source' charmcraft.yaml)
```

## Canonical Contributor Agreement

Canonical welcomes contributions to Charmed Hook Service. Please check out
